...
class Experiment(BaseExperiment):
    def __init__(self, debug=False):
        ...
        self.experiment_name = "train_usokin-500g-scaled-2L-adam-ae"
        if self.debug:
    ...
    def generate_search_space(self):
        return {
            "encoder_layer_sizes": [
                ...
                hp.choice("latent_layer", list(np.arange(50, 201, step=50)))
            ],
    ...
    def get_model_config(self, case_config):
        ...
        model_name = "{}_UsokinAE_{}-{}_{}_{}".format(
            self.case_counter,
    ...
    def train_ae(self, case_config):
        ...
        for k in range(0, 10):
            ...
            fold_valid_loss = ae.evaluate(valid_dataset)
    ...
    def run(self, debug=False):
        ...
        self.train_final_ae(best_model_config)
