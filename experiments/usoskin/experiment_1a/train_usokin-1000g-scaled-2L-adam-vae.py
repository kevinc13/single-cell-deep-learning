...
class Experiment(BaseExperiment):
    def __init__(self, debug=False):
        ...
        self.experiment_name = "train_usokin-1000g-scaled-2L-adam-vae"
        if self.debug:
    ...
    def generate_search_space(self):
        return {
            "encoder_layer_sizes": [
                hp.choice("layer1", list(np.arange(650, 951, step=50))),
                hp.choice("layer2", list(np.arange(350, 601, step=50)))
            ],
